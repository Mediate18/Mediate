...
MIDDLEWARE = [
    'mediate.middleware.OldHostNameWarningMiddleware',
...
DATA_UPLOAD_MAX_MEMORY_SIZE = config('DATA_UPLOAD_MAX_MEMORY_SIZE', 30 * 1024 * 1024, cast=int)
FILE_UPLOAD_MAX_MEMORY_SIZE = config('FILE_UPLOAD_MAX_MEMORY_SIZE', 15 * 1024 * 1024, cast=int)
