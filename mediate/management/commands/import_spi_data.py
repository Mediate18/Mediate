...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if new:
            new_objects.append(dummy_collection)
        ...
        for row in resultSet:
            ...
            if new:
                new_objects.append(parent_category)
        ...
        for row in resultSet:
            ...
            try:
                ...
                if row['book_format']:
                    ...
                    if new:
                        new_objects.append(book_format)
                insert_fields = {
        ...
        json_str = serializers.serialize("json", new_objects)
        if pretty_print:
