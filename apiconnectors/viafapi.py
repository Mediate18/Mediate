"""
Micha Hulsbsoch, 2022-10-05:
This file contains the code from https://github.com/Princeton-CDH/viapy/blob/main/viapy/api.py
because the repository seems no longer maintained and I just needed this code.
"""
import logging
import time
